...
访问[凭据](https://console.cloud.google.com/apis/credentials)，点击**创建凭据->API 密钥**，获得API密钥。

![image-20230512121459523](img/image-20230512121459523.png)
...
- [x] 百度，该接口不能播放对话，因为只有一种声音。声音还可以，不刺耳。（免费）
- [x] 搜狗，可以生成文章和对话的播放，声音一般般。（免费）
- [x] ~~有道，接口失效~~
- [x] 谷歌云，可以生成文章和对话的播放，声音可以。（绑信用卡免费，有免费额度限度）
- [x] 微软云，可以生成文章和对话的播放，声音可以。（绑信用卡免费，有免费额度限度）
