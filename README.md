...
### 语法批改
  ...
  > 在`config.py`配置`syntactic_correction`参数

![image-20230425140618463](img/image-20230425140618463.png)

> 官方自带语法批改功能，不过**不支持语音语法批改**。
>
> ![QQ录屏20230425140427](img/20230425140427.gif)

### 语音和文本同时输出

> 在`config.py`配置`text_and_audio`参数

> 不建议使用该功能，可以使用**原文功能**进行补充。

![image-20230425141112526](img/image-20230425141112526.png)
...
![image-20230423105041686](img/image-20230423105041686.png)

### 清除会话状态

![image-20230425135845034](img/image-20230425135845034.png)
...
![image-20230420165546500](img/image-20230420165546500.png)
...
![image-20230425135125224](img/image-20230425135125224.png)

### 表情替代文字

![image-20230421140057206](img/image-20230421140057206.png)

### 单词分析

![image-20230425135236204](img/image-20230425135236204.png)
...
![image-20230425135542742](img/image-20230425135542742.png)

输出阅读答案

![image-20230425135617046](img/image-20230425135617046.png)
