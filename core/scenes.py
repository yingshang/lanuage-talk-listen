...
scene = {
    ...
    "托福学术讨论写作":"基于新托福独立写作模式，创建一个学术讨论写作模式。\n学术讨论写作模式格式：教授在讲授X课程提出两个观点，同学1同意第一个观点并说明理由，同学2同意第二个观点并说明理由。\n生成相关英文内容的格式如下：\n\n【Professor】：\n【Student 1】:\n 【Student 2】：\n【end content】\n",
    "托福学术讨论写作答案生成":"基于新托福独立写作模式，选择一个观点，并基于这个观点进行内容补充。单词数至少100个，最多130个。"
}
