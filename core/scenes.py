...
school_scenes = {
    ...
    "学校宿舍场景":['宿舍的安排','学生校外租房','房间设施问题','室友之间相处问题','宿舍政策'],
    "学校图书馆场景":['找不到想借的书','还书过期','图书馆准备考试复习','准备论文','使用图书馆设施','查询资料','借书还书','买书'],
    "学校假期场景":['假期去哪玩','回忆假期去过哪','有什么好玩的'],
    "学校办公室场景":['上课请假','延期交作业','论文准备','选课咨询','论文选题','论文写作','关于论文问题','其他活动申请'],
    "学生注册场景":['开学注册问题','选课问题','缴费问题','选课困难','毕业需求','课程学分计算'],
    "学校维护场景":['教室的桌椅损坏','宿舍的物品损坏','维护时间协商'],
    "勤工俭学场景":['兼职工作',"与课程时间冲突，协调工作时间","招聘应聘",'参加 career fair','工作条件/工资相关'],
    "学校场景":['奖学金申请','奖学金问题'],
